...
API_ID = int(environ['API_ID'"26305156"])
API_HASH = environ['API_HASH'"9937930c368c669ca905e9a95aa712f0"]
BOT_TOKEN = environ['BOT_TOKEN'"6652027028:AAE4_AO8b7TNwWqHdIdIzJJsUL7FUGte-wE"]

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = is_enabled((environ.get('USE_CAPTION_FILTER', 'True')), True)

PICS = (environ.get('PICS', https://telegra.ph/file/8066aa5312b255d3246db.jpg https://telegra.ph/file/b17c360f0bdb6ecf799e9.jpg)).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002205728742').split()]
...
reqst_channel = environ.get('-1002176478139')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'False')), False)

# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI, "mongodb+srv://Ilashadam:ilashadam@cluster0.blzprnr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "propes")
